...
/// 设置插屏广告尺寸
extern NSString * const kUnionInterstitialExtraAdSizeKey;


@interface UnionAdManager (interstitial)
...
+ (void)showInterstitialWithAdSlotID:(NSString *)slotID
                    inViewController:(UIViewController*)viewController
                            delegate:(id<UnionInterstitialDelegate>)delegate;
